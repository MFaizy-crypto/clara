...
<div class="widget-header">
    <div class="row">
        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
            <div class="m-3"> <span style="font-size:18px;">Edit News Articles</span>
           </div>
        </div>
    </div>
</div>
<div class="widget-content widget-content-area">
   <div class="table-responsive">
    <form method="POST" action="{{ route('news-artical-update') }}" enctype="multipart/form-data" id="news_articles">
        @csrf
                ...
                <div class="profile-image">
                    ...
                    <div class="media">
                        <div class="avatar me-2">
                            <img alt="avatar" src="{{url('/img/news-articles').'/'.$data->image}}" class="rounded-circle" />
                        </div>
                    </div>
                </div>
        </div>
    ...
    <a href="{{url('/admin/news-articles')}}" class="btn badge-danger pt-2">Cancel</a>
</form>
