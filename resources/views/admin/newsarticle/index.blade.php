...
<div class="widget-header">
    <div class="row">
        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
            <div class="m-3"> <span style="font-size:18px;"> News Articles List </span>
            <span style="float:right"><a href="{{url('/admin/news-articles/add')}}" class="btn btn__primary">Add News Articles</a></span></div>
        </div>
    </div>
</div>
    ...
    <form action="">
     <div class="row pb-3">
            <div class="col-sm-4">
             ...
             <div class="col-sm-4">
                    ...
                    <input type="text" name="description_search" id="description_search" class="form-control" value="{{($request->description_search)? $request->description_search : ''}}">
            </div>
     ...
     <div class="row pb-3">
         <div class="col-sm-4">
                ...
                <a href="{{url('/admin/news-articles')}}" class="btn badge-danger pt-2">Reset</a>
             </div>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                 ...
                 <td>
                    <p class="mb-0">{!! \Illuminate\Support\Str::limit($value->description, 50, $end='...') !!}</p>
                   <!--  <span class="text-success">Management</span> -->
                </td>
                 <td>
                    <div class="media">
                        <div class="avatar me-2">
                            <img alt="avatar" src="{{url('/img/news-articles').'/'.$value->image}}" class="rounded-circle" />
                        </div>
                    </div>
                </td>
                ...
                <td class="text-center">
                    <div class="action-btns">
                      <!--   <a href="javascript:void(0);" class="action-btn btn-view bs-tooltip me-2" data-toggle="tooltip" data-placement="top" title="View">
                        ...
                        <a href="{{url('/admin/news-articles/edit').'/'.$value->id}}" class="action-btn btn-edit bs-tooltip me-2" data-toggle="tooltip" data-placement="top" title="Edit">
...
$(".delete").on('click', function(event){
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        $.ajax({
	        type: 'post',
	        url: getsiteurl()+"/admin/news-articles/delete",
	        data: {id:id,
	            '_token': '{{ csrf_token() }}',
	        },
	        dataType: 'JSON',
