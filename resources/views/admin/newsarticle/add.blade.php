...
<div class="widget-header">
    <div class="row">
        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
            <div class="m-3"> <span style="font-size:18px;">Add News Articles</span>
           </div>
        </div>
    </div>
</div>
<div class="widget-content widget-content-area">
   ...
   <div class="table-responsive">
    <form method="POST" action="{{ route('news-artical-store') }}" enctype="multipart/form-data" id="news_articles">
        @csrf
    <div class="row mb-4">
        <div class="col-sm-12">
