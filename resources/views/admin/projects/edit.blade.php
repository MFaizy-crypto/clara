...
<div class="widget-header">
    <div class="row">
        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
            <div class="m-3"> <span style="font-size:18px;">Edit Project</span>
           </div>
        </div>
    </div>
</div>
<div class="widget-content widget-content-area">
   <div class="table-responsive">
    <form method="POST" action="{{ route('projects-update') }}" enctype="multipart/form-data" id="projects">
        @csrf
                ...
                <div class="profile-image">
                    ...
                    <div class="media">
                        <div class="avatar me-2">
                            <img alt="avatar" src="{{url('/img/projects').'/'.$data->image}}" class="rounded-circle" />
                        </div>
                    </div>
                </div>
        </div>
