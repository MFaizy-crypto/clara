...
<div class="widget-header">
    <div class="row">
        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
            <div class="m-3"> <span style="font-size:18px;"> Projects List </span>
            <span style="float:right"><a href="{{url('/admin/projects/add')}}" class="btn btn__primary">Add Project</a></span></div>
        </div>
    </div>
</div>
    ...
    <form action="">
     ...
     <div class="row pb-3">
         <div class="col-sm-4">
                ...
                <a href="{{url('/admin/projects')}}" class="btn badge-danger pt-2">Reset</a>
             </div>
                 ...
                 <td>
                    <div class="media">
                        <div class="avatar me-2">
                            <img alt="avatar" src="{{url('/img/projects').'/'.$value->image}}" class="rounded-circle" />
                        </div>
                    </div>
                </td>
                ...
                <td class="text-center">
                    <div class="action-btns">
                      <!--   <a href="javascript:void(0);" class="action-btn btn-view bs-tooltip me-2" data-toggle="tooltip" data-placement="top" title="View">
                        ...
                        <a href="{{url('/admin/projects/edit').'/'.$value->id}}" class="action-btn btn-edit bs-tooltip me-2" data-toggle="tooltip" data-placement="top" title="Edit">
...
$(".delete").on('click', function(event){
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        $.ajax({
	        type: 'post',
	        url: getsiteurl()+"/admin/projects/delete",
	        data: {id:id,
	            '_token': '{{ csrf_token() }}',
	        },
	        dataType: 'JSON',
